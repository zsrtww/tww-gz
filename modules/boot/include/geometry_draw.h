...
#include "libtww/include/JSystem/J3DGraphBase/J3DPacket.h"
...
class mDoExt_ArrowPacket {
public:
    mDoExt_ArrowPacket(cXyz& startPos, cXyz& endPos, const GXColor& color, u8 clipZ, u8 width) {
        mStartPos = startPos;
        mEndPos = endPos;
        mColor = color;
        mClipZ = clipZ;
