...
twwgz::containers::deque<GZSettingEntry*> g_settings;
...
KEEP_FUNC twwgz::containers::deque<GZSettingID>* GZStng_getList() {
    auto list = new twwgz::containers::deque<GZSettingID>;
