...
const char* g_menuPaths[MN_COUNT] = {"main",           "cheats",
                                     "flags",          "inventory",
                                     "memory",         "practice",
                                     "scene",          "settings",
                                     "tools",          "general_flags",
                                     "dungeon_flags",  "savewarp_flags",
                                     "tuner_flags",    "amounts",
                                     "item_inventory", "quest_status",
                                     "delivery_bag",   "spoils_bag",
                                     "bait_bag",       "charts",
