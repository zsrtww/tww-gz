...
KEEP_FUNC PMGSavesMenu::PMGSavesMenu(Cursor& cursor)
    : Menu(cursor),
      lines{{"after intro", AFTER_INTRO_PMG, "just after the intro, at bottom of watchtower"},
            ...
            {"drc boss key skip", DRC_PMGK_SKIP_PMG, "inside drc in boss door room for bk skip"},
            ...
            {"fw boss key skip", FW_PMGK_SKIP_PMG, "in main room of fw, near warp pot, about to store morth pit chest"},
