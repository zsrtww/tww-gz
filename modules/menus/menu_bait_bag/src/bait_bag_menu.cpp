...
KEEP_FUNC BaitBagMenu::BaitBagMenu(Cursor& cursor)
    : Menu(cursor), lines{
                        {"slot 1:", BAITSLOT1_INDEX,
                         "Modify the item in bait bag slot 1 (modify bait amount with A)"},
                        {"slot 2:", BAITSLOT2_INDEX,
                         "Modify the item in bait bag slot 2 (modify bait amount with A)"},
                        {"slot 3:", BAITSLOT3_INDEX,
                         "Modify the item in bait bag slot 3 (modify bait amount with A)"},
                        {"slot 4:", BAITSLOT4_INDEX,
                         "Modify the item in bait bag slot 4 (modify bait amount with A)"},
                        {"slot 5:", BAITSLOT5_INDEX,
                         "Modify the item in bait bag slot 5 (modify bait amount with A)"},
                        {"slot 6:", BAITSLOT6_INDEX,
                         "Modify the item in bait bag slot 6 (modify bait amount with A)"},
                        {"slot 7:", BAITSLOT7_INDEX,
                         "Modify the item in bait bag slot 7 (modify bait amount with A)"},
                        {"slot 8:", BAITSLOT8_INDEX,
                         "Modify the item in bait bag slot 8 (modify bait amount with A)"},
                    } {}
