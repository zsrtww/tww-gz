...
void AnyNoMssSavesMenu::draw() {
    ...
    if (GZ_getButtonTrig(SELECTION_BUTTON)) {
        special AnyNoMssSpecials[] = {
            special(FOREST_OF_FAIRIES, SaveMngSpecial_SetLayer0, nullptr),
            special(ROPES_1, SaveMngSpecial_SetLayer0, nullptr),
            special(WINDFALL, SaveMngSpecial_SetLayer0, nullptr),
            special(BOMBS_SWIM, SaveMngSpecial_BombsSwim_NoMSS, nullptr),
            special(ROPES_2, SaveMngSpecial_SetLayer2, nullptr),
            special(FH_SWIM, SaveMngSpecial_SetLayer0, nullptr),
            special(DTCS, SaveMngSpecial_DTCS, nullptr),
            special(QUIVER_SWIM, SaveMngSpecial_PostLeafHover, nullptr),
            special(FF2_SWIM, SaveMngSpecial_ExitThornedFairy, nullptr),
            special(HELMAROC_SKIP, SaveMngSpecial_SetLayer3, nullptr),
            special(BARRIER_SKIP, SaveMngSpecial_BarrierSkip, nullptr),
            special(TRIALS_SKIP, SaveMngSpecial_TrialsSkip, nullptr),
            special(PG_FIGHT, SaveMngSpecial_PuppetGanon, nullptr),
            special(MORTH_HOVER, SaveMngSpecial_MorthHover, nullptr),
