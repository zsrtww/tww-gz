...
KEEP_FUNC CheatsMenu::CheatsMenu(Cursor& cursor)
    : Menu(cursor),
      lines{
          ...
          {"infinite hearts", InfiniteHearts, "Always have full hearts", true, ACTIVE_FUNC(STNG_CHEATS_INFINITE_HEARTS)},
          {"refill health", RefillHealth, "Hold R+D-pad right to refill health", true, ACTIVE_FUNC(STNG_CHEATS_REFILL_HEALTH)},
          ...
          {"infinite rupees", InfiniteRupees, "Always have infinite rupees", true, ACTIVE_FUNC(STNG_CHEATS_INFINITE_RUPEES)},
          ...
          {"door cancel", DoorCancel, "Hold L+D-pad left to get door cancel", true, ACTIVE_FUNC(STNG_CHEATS_DOOR_CANCEL)},
          ...
          {"upcharge", Upcharge, "Hold X + Z to get negative speed for upcharge", true, ACTIVE_FUNC(STNG_CHEATS_UPCHARGE)}} {}
