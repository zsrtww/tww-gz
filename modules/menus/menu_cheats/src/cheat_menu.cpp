...
KEEP_FUNC CheatsMenu::CheatsMenu(Cursor& cursor)
    : Menu(cursor),
      lines{
          ...
          {"infinite arrows", InfiniteArrows, "Always have max arrows", true, &g_cheats[InfiniteArrows].active},
          {"infinite bombs", InfiniteBombs, "Always have max bombs", true, &g_cheats[InfiniteBombs].active},
          {"infinite hearts", InfiniteHearts, "Always have full hearts", true, &g_cheats[InfiniteHearts].active},
          {"refill health", RefillHealth, "Hold R+D-pad right to refill health", true, &g_cheats[RefillHealth].active},
          {"infinite magic", InfiniteMagic, "Always have full magic", true, &g_cheats[InfiniteMagic].active},
          {"refill magic", RefillMagic, "Hold L+D-pad up to refill magic", true, &g_cheats[RefillMagic].active},
