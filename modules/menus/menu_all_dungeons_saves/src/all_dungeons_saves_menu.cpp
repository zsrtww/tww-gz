#include "menus/menu_all_dungeons_saves/include/all_dungeons_saves_menu.h"
#include "gz_flags.h"
...
KEEP_FUNC AllDungeonsSavesMenu::AllDungeonsSavesMenu(Cursor& cursor)
    : Menu(cursor),
      lines{
          ...
          {"early leaf hover", EARLY_LEAF_HOVER_AD,
           "outside forest haven for hover to higher entrance"},
          {"deku tree cutscene skip", DEKU_TREE_CS_AD,
           "inside forest haven upper spawn for cutscene skip"},
          ...
          {"hyrule escape", HYRULE_ESCAPE_AD,
           "inside hyrule castle after master sword for hyrule escape"},
          ...
          {"swim to flight control platform", SWIM_2_FCP_AD,
           "at gale isle for swim to flight control platform"},
          {"fcp layer manip", FCP_LAYER_MANIP_AD,
           "at flight control platform for layer manip dark portal"},
          {"puppet ganon cutscene skip", PG_CS_AD,
           "in grand staircase for puppet ganon cutscene skip"},
          {"puppet ganon skip", PG_SKIP_AD,
           "in puppet ganon room on layer 8 for puppet ganon skip"},
...
void AllDungeonsSavesMenu::draw() {
    ...
    if (GZ_getButtonTrig(SELECTION_BUTTON)) {
        special AllDungeonsSpecials[] = {
            ...
            special(ENTER_DRC_AD, SaveMngSpecial_Enter_DRC_AD_During,
                    SaveMngSpecial_Enter_DRC_AD_After),
            ...
            special(ENTER_TOTG_AD, SaveMngSpecial_Enter_TOTG_AD_During,
                    SaveMngSpecial_Enter_TOTG_AD_After),
            special(TOTG_AD, nullptr, SaveMngSpecial_TOTG_AD_After),
            special(DARKNUT_AD, SaveMngSpecial_Darknut_AD, nullptr),
            special(TOTG_AFTER_STATUE2_AD, SaveMngSpecial_After_Statue2_AD_During,
            ...
            special(PHANTOM_GANON_AD, SaveMngSpecial_Phantom_Ganon_AD_During,
                    SaveMngSpecial_Phantom_Ganon_AD_After),
            special(ENTER_HELM_AD, SaveMngSpecial_Phantom_Ganon_AD_During,
                    SaveMngSpecial_Enter_Helm_AD_After),
            special(HYRULE2_SKIP_AD, SaveMngSpecial_HelmarocKing,
                    SaveMngSpecial_Hyrule2_Skip_AD_After),
            ...
            special(ENTER_WT_AD, SaveMngSpecial_Enter_WT_AD_During,
                    SaveMngSpecial_Enter_WT_AD_After),
