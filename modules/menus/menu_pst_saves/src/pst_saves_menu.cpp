...
KEEP_FUNC PSTSavesMenu::PSTSavesMenu(Cursor& cursor)
    : Menu(cursor),
      lines{
          ...
          {"islet of steel swim", IOS_PST, "at nti for swim to ios"},
          ...
          {"darknut", DARKNUT_PST, "totg darknut miniboss"},
          ...
          {"stonewatcher swim", STONEWATCHER_SWIM_PST, "at headstone for swim to stonewatcher"},
          {"stonewatcher cave", STONEWATCHER_PST, "in stonewatcher cave for triforce chart"},
          ...
          {"overlook swim", OVERLOOK_SWIM_PST, "at gale isle for swim to overlook"},
          {"overlook cave", OVERLOOK_PST, "in overlook cave for triforce chart"},
          {"private oasis", PRIVATE_OASIS_PST, "at private oasis for chest storage early cabana"},
