    ...
    : Menu(cursor),
      lines{
          {"FF2 Helmaroc Cutscene", WATCHED_FF2_HELMAROC_CUTSCENE, "Switches to animation set 2, among other things",
           true, []() {return g_flags[WATCHED_FF2_HELMAROC_CUTSCENE];}},
          {"FF1 Gossip Stone Trigger", GOSSIP_STONE_TRIGGER,
           "Sets Pirate Ship to layer 2 (Ropes 2) and Outset to layer 4", true, []() {return g_flags[GOSSIP_STONE_TRIGGER];}},
          {"Post FF1 KoRL Cutscene", GENERAL_POST_FF1_KORL_CUTSCENE,
           "Spawns KoRL, sets savewarp to Windfall and FoF to layer 2", true, []() {return g_flags[GENERAL_POST_FF1_KORL_CUTSCENE];}},
          {"Endless Night", ENDLESS_NIGHT, "Activates Endless Night, incompatible with having Nayru's Pearl", true,
           []() {return g_flags[ENDLESS_NIGHT];}},
          {"Raise TotG", RAISE_TOTG, "Raises Tower of the Gods", true, []() {return g_flags[RAISE_TOTG];}},
          {"Load TotG After T2Z", LOAD_TOTG_AFTER_T2Z, "Sets FF3 Layer and F&I Arrows at M&C", true,
           []() {return g_flags[LOAD_TOTG_AFTER_T2Z];}},
          {"Hyrule 3 Warp", OPEN_HYRULE3_WARP, "Opens golden warp to Hyrule 3", true, []() {return g_flags[OPEN_HYRULE3_WARP];}},
          {"Hyrule Barrier", DESTROY_HYRULE_BARRIER, "Barrier Skip Skip", true, []() {return g_flags[DESTROY_HYRULE_BARRIER];}},
          {"Dark Portal", OPEN_DARK_PORTAL, "Opens dark portal between FF3 and Ganon's Tower", true,
           []() {return g_flags[OPEN_DARK_PORTAL];}},
          {"Sea Chart", GET_SEA_CHART, " Gives the sea chart ", true, []() {return g_flags[GET_SEA_CHART];}},
      } {}
