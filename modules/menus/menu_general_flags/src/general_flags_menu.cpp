...
KEEP_FUNC GeneralFlagsMenu::GeneralFlagsMenu(Cursor& cursor)
    : Menu(cursor),
      lines{
          {"FF2 Helmaroc Cutscene", WATCHED_FF2_HELMAROC_CUTSCENE,
           "Switches to animation set 2, among other things", true,
          ...
          {"Endless Night", ENDLESS_NIGHT,
           "Activates Endless Night, incompatible with having Nayru's Pearl", true,
