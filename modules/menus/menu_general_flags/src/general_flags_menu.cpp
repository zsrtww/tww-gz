    ...
    : Menu(cursor),
      lines{
          ...
          {"FF1 Gossip Stone Trigger", GOSSIP_STONE_TRIGGER,
           "Sets Pirate Ship to layer 2 (Ropes 2) and Outset to layer 4", true,
           []() { return g_flags[GOSSIP_STONE_TRIGGER]; }},
          {"Post FF1 KoRL Cutscene", GENERAL_POST_FF1_KORL_CUTSCENE,
           "Spawns KoRL, sets savewarp to Windfall and FoF to layer 2", true,
           []() { return g_flags[GENERAL_POST_FF1_KORL_CUTSCENE]; }},
          ...
          {"Hyrule 3 Warp", OPEN_HYRULE3_WARP, "Opens golden warp to Hyrule 3", true,
           []() { return g_flags[OPEN_HYRULE3_WARP]; }},
          {"Hyrule Barrier", DESTROY_HYRULE_BARRIER, "Barrier Skip Skip", true,
           []() { return g_flags[DESTROY_HYRULE_BARRIER]; }},
