...
void AllDungeonsSavesMenu::draw() {
    ...
    if (GZ_getButtonTrig(SELECTION_BUTTON)) {
        special AllDungeonsSpecials[] = {
            special(FF1_CS_AD, SaveMngSpecial_FF1CS_AD, nullptr),
            special(WINDFALL_AD, SaveMngSpecial_SetLayer0, nullptr),
            special(ROPES_2_AD, SaveMngSpecial_SetLayer2, nullptr),
            special(EARLY_LEAF_HOVER_AD, SaveMngSpecial_EarlyLeafHover_AD, nullptr),
            special(DEKU_TREE_CS_AD, SaveMngSpecial_DTCS_AD, nullptr),
            special(KALLE_DEMOS_AD, SaveMngSpecial_KalleDemos_AD, nullptr),
            special(ENTER_DRC_AD, SaveMngSpecial_EnterDRC_AD, nullptr),
            special(DRC_MB_AD, SaveMngSpecial_DRCMiniboss_AD, nullptr),
            special(DRC_BKS_AD, SaveMngSpecial_DRCBossKeySkip_AD, nullptr),
            special(NAYRUS_PEARL_AD, SaveMngSpecial_NayrusPearl_AD, nullptr),
            special(ENTER_TOTG_AD, SaveMngSpecial_EnterTOTG_AD, nullptr),
            special(TOTG_AD, SaveMngSpecial_TOTG_AD, nullptr),
            special(DARKNUT_AD, SaveMngSpecial_Darknut_AD, nullptr),
            special(TOTG_AFTER_STATUE2_AD, SaveMngSpecial_AfterStatue2_AD, nullptr),
            special(HYRULE_ESCAPE_AD, SaveMngSpecial_HyruleEscape_AD, nullptr),
            special(BARRIER_SKIP_AD, SaveMngSpecial_BarrierSkip_AD, nullptr),
            special(TRIAL_SKIP_AD, SaveMngSpecial_TrialsSkip_AD, nullptr),
            special(BOOMERANG_SKIP_AD, SaveMngSpecial_BoomerangSkip_AD, nullptr),
            special(PHANTOM_GANON_AD, SaveMngSpecial_PhantomGanon_AD, nullptr),
            special(ENTER_HELM_AD, SaveMngSpecial_EnterHelmaroc_AD, nullptr),
            special(HYRULE2_SKIP_AD, SaveMngSpecial_Hyrule2Skip_AD, nullptr),
            special(FIRE_MOUNTAIN_AD, SaveMngSpecial_FireMountain_AD, nullptr),
            special(EARLY_ET_AD, SaveMngSpecial_EarlyET_AD, nullptr),
            special(ET_AD, SaveMngSpecial_ET_AD, nullptr),
            special(SONGTONE_SKIP_AD, SaveMngSpecial_SongstoneSkip_AD, nullptr),
            special(JALHALLA_AD, SaveMngSpecial_Jalhalla_AD, nullptr),
            special(ICE_RING_AD, SaveMngSpecial_IceRing_AD, nullptr),
            special(MAKAR_AD, SaveMngSpecial_Makar_AD, nullptr),
            special(ENTER_WT_AD, SaveMngSpecial_EnterWT_AD, nullptr),
            special(WT_AD, SaveMngSpecial_WT_AD, nullptr),
            special(WIZZROBE_AD, SaveMngSpecial_Wizzrobe_AD, nullptr),
            special(AFTER_HS_AD, SaveMngSpecial_AfterHS_AD, nullptr),
            special(SWIM_2_FCP_AD, SaveMngSpecial_Swim2FCP_AD, nullptr),
